package io.brainwork.hillcode.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, io.brainwork.hillcode.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, io.brainwork.hillcode.repository.UserRepository.USERS_BY_EMAIL_CACHE);
