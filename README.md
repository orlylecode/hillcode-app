...
To build the final jar and optimize the hillcodeApp application for production, run:
...
Then navigate to [http://localhost:6666](http://localhost:6666) in your browser.
